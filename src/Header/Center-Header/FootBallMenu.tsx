...
function FootBallMenu() {
  ...
  return (
    <div
      className="cursor-pointer border-[#23262E]/[10%] transition-transform flex w-[160px] border-solid border-[1px] rounded-[8px] p-0 h-10 place-items-center justify-between gap-2 pr-2"
