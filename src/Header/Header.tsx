...
function Header() {
  return (
    <header className="flex max-lg:flex-col justify-center bg-white top-0 left-0 w-full h-[5rem] lh:h-[6] fixed z-10">
      <div className="grid grid-cols-[1fr_6fr] max-w-1024-header gap-8 h-full justify-center max-w-1024-padding px-20 items-center w-full max-w-[1500px]">
        <div className="flex items-center max-w-1024-left-header max-lg:justify-between justify-between">
          <BurgerMenu />
